...
def send_test_email():
    ...
    print(f"   ✅ CTA Link: https://yapmate.co.uk/app (redirects to App Store)")
    print(f"   ✅ Footer Image: {image_url}")
    ...
    try:
        ...
        print(f"   ✅ CTA: 'Download YapMate' → yapmate.co.uk/app")
        print(f"   ✅ Footer image: {image_url}")
        print(f"   ✅ Image is clickable (links to yapmate.co.uk/app)")

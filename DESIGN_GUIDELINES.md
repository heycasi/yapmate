# YapMate AI - Design Guidelines

**Purpose:** UI/UX design patterns for the "Rugged Utility" design system
**Audience:** Designers and frontend developers working on YapMate

For iOS development workflows and App Store submission, see `CLAUDE.md`
...
2.  Reference these Brand Guidelines in DESIGN_GUIDELINES.md.
